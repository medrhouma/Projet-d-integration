  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 text-sm font-medium text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg transition-all"
          >
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-start">
            ...
            <Link
              ...
              className="px-6 py-3 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 rounded-lg transition-all flex items-center gap-2"
            >
        ...
        <div className="bg-blue-600 border border-blue-700 rounded-xl p-6 text-white mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 bg-white/20 border-4 border-white/30 rounded-full flex items-center justify-center">
            ...
            <Link
              href="/dashboard-etudiant/profil"
              className="px-6 py-3 bg-white/20 hover:bg-white/30 border border-white/30 text-white rounded-lg transition-all font-medium"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-blue-50 border border-blue-100 rounded-lg hover:bg-blue-100 transition-all">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Aujourd'hui à 10:00 - Salle A101</p>
                  </div>
                </div>
                <span className="bg-blue-600 border border-blue-700 text-white text-xs px-3 py-1 rounded-full font-medium">
                  Dans 2h
                </span>
              </div>
              
              <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-lg hover:bg-gray-100 transition-all">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Aujourd'hui à 14:00 - Salle B202</p>
                  </div>
                </div>
                <span className="bg-gray-200 border border-gray-300 text-gray-700 text-xs px-3 py-1 rounded-full font-medium">
                  Dans 6h
                </span>
              </div>
